...
- System databases are now automatically excluded in exclusion mode, aligning it with the other database selection modes. Existing exclusion lists no longer retain system database names.
